...
//var dir : File = context.getFilesDir().getParentFile()//context.getExternalFilesDir("pending_downloads")
	...
	val openURL = Intent(android.content.Intent.ACTION_VIEW)	    
        openURL.data = Uri.parse("myket://comment?id=com.draco.ludere.pirateTwo")
        
	/*bazar*/
	//val openURL = Intent(android.content.Intent.ACTION_EDIT)
        //openURL.data = Uri.parse("bazaar://details?id=com.draco.ludere.pirateTwo")
	...
	/*myket*/
        openURL.data = Uri.parse("myket://details?id=com.draco.ludere.pirateTwo")
