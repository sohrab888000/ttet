...
class MainActivity : AppCompatActivity() {
	...
	*/
       //for publish in pico file and aparat
	        ...
	        TapsellPlus.initialize(this@MainActivity, "fsbnajfqmreohcjkcpeofhirkascmofipdrtgjcqsckjgmherqacdseerkngacsffqkdke" ,
...
//var dir : File = context.getFilesDir().getParentFile()//context.getExternalFilesDir("pending_downloads")
	...
	val openURL = Intent(android.content.Intent.ACTION_VIEW)	    
        openURL.data = Uri.parse("myket://comment?id=com.draco.ludere.FIFA2014")
        
	/*bazar*/
	//val openURL = Intent(android.content.Intent.ACTION_EDIT)
        //openURL.data = Uri.parse("bazaar://details?id=com.draco.ludere.FIFA2014")
	...
	/*myket*/
        openURL.data = Uri.parse("myket://details?id=com.draco.ludere.FIFA2014")
